...
public class ProcesarDatos {
    ...
    public void leerArchivo(String ruta) throws MisExcepciones {
    ...
    public void lecturaYEscritura(String ruta) throws MisExcepciones {
        ...
        try {
            ...
            throw new MisExcepciones(e.getCause().toString(), e.getMessage());
        } catch (IOException e) {
            throw new MisExcepciones(e.getCause().toString(), e.getMessage());
        } catch (ArrayIndexOutOfBoundsException e) {
            throw new MisExcepciones(CAUSA + e.getCause(),
            ...
            try {
                ...
                throw new MisExcepciones(CAUSA + e.getCause(), FALLA + "el objeto es " + e.getMessage());
            }
        }
    }
}
